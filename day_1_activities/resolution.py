...
def add_student():
    ...
    for student in students:
        ...
        if student["cps_id"] == cps_id:
            ...
            return #im guessing its the same as a break statement like in a while loop
    ...
    print(new_student)
    print("-------------------------------------")
    print(f"total students in system: {len(student)}")
...
while True:
    ...
    if choice == "1":
        ...
        if result:
           print ("\n Student found:")
           #print cps_id, name, homeroom, grade, primary_email, seconday_email
           print("CPS_ID:", result["cps_id"])
           ...
           # For a way quicker way using for loops
